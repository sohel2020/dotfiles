...
tmux setw -g window-status-format "#[fg=${thm_black4}] #(~/.config/tmux/scripts/circle_number.sh #I) #{?#{window_name},#W,#{b:pane_current_path}} "
tmux setw -g window-status-current-format "#[fg=${thm_magenta},bold] #(~/.config/tmux/scripts/circle_number.sh #I) #{?#{window_name},#W,#{b:pane_current_path}} "
